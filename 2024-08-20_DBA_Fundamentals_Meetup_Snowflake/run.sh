...
# ---
# Sample 5: Streamlit apps
# ---

cd cd ../../tmp/localstack-snowflake-samples/streamlit-snowpark-dynamic-filters
...
# ---
# Sample 7: Local cloud proxy
# ---

Proxy host, e.g.: `<orgID>-<accountId>.snowflakecomputing.com`
