...
awslocal lambda create-function --function-name hot-reload --code '{"S3Bucket":"__local__","S3Key":"'$PWD'"}' --handler lambda.handler --runtime python3.7 --role r1 --timeout 10
